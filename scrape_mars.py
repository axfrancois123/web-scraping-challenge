...
def init_browser():
    execute_path = {"executable_path": "chromedriver.exe"}
...
def scrape():
    ...
    for mars in mars_hemis:
        ...
        hemi_links = mars.a['href']
        hemi_url = "https://marshemispheres.com/" + hemi_links
        ...
        hemis_dict = {}
        hemis_dict["title"] = hemis_titles
        hemis_dict["image_url"] = hemis_image_url
        ...
        print(hemis_titles)
        print("------------")
        print(hemi_url + hemis_image_url) 
